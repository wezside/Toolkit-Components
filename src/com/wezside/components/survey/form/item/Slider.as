package com.wezside.components.survey.form.item
{
	...
	public class Slider extends UIElement implements IFormItem {
		...
		public function get type():String { return FormItem.ITEM_SLIDER; }
		
		public function get value():String { return data.value; }
		public function set value( value : String ) : void {_data.value; }
		
		public function get selected():Boolean { return true; }
		...
		public function get sliderData():Collection { return _sliderData; }
		public function set sliderData( value : Collection ) : void { _sliderData = value; }
